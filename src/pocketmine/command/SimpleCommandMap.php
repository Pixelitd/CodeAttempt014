...
use pocketmine\command\defaults\CountryCommand;
...
use pocketmine\command\defaults\ProtocolVersionCommand;
...
use pocketmine\command\defaults\LanguageCommand;
...
class SimpleCommandMap implements CommandMap
{
	...
	private function setDefaultCommands()
	{
		...
		$this->register("pocketmine", new CountryCommand("country"));
		...
		$this->register("pocketmine", new ProtocolVersionCommand("protocolversion"));
		...
		$this->register("pocketmine", new LanguageCommand("language"));
