...
class FolderPluginLoader implements PluginLoader
{
	...
	public function loadPlugin($file)
	{
		if (is_dir($file) and file_exists($file . "/plugin.yml") and file_exists($file . "/src/")) {
			if (($description = $this->getPluginDescription($file)) instanceof PluginDescription) {
				MainLogger::getLogger()->debug(TextFormat::LIGHT_PURPLE . "Loading source plugin " . $description->getFullName());
	...
	public function enablePlugin(Plugin $plugin)
	{
		if ($plugin instanceof PluginBase and !$plugin->isEnabled()) {
			MainLogger::getLogger()->debug("Enabling " . $plugin->getDescription()->getFullName());
	...
	{
		if ($plugin instanceof PluginBase and $plugin->isEnabled()) {
			MainLogger::getLogger()->debug("Disabling " . $plugin->getDescription()->getFullName());
