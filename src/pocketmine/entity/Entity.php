...
abstract class Entity extends Location implements Metadatable
{
	...
	public function fall($fallDistance)
	{
		...
		if ($this->getLevel()->getServer()->destroyBlockParticle and $fallDistance > 5) {
		...
		if ($this->level->getBlock($this->temporalVector->setComponents(Math::floorFloat($this->x), Math::floorFloat($y = ($this->y)), Math::floorFloat($this->z))) instanceof Water) {
			$damage = 0;
		}
		if ($damage > 0) {
