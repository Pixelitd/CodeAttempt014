...
class CraftingManager
{
	...
	public function __construct(bool $useJson = false)
	{
		...
		if ($useJson) {
			...
			$this->registerRecipe((new ShapedRecipe(
				Item::get(Item::WOODEN_PLANK, Planks::OAK, 4),
				"X"
			))->setIngredient("X", Item::get(Item::WOOD, Wood::OAK, 1)));
			$this->registerRecipe((new ShapedRecipe(
				Item::get(Item::WOODEN_PLANK, Planks::SPRUCE, 4),
				"X"
			))->setIngredient("X", Item::get(Item::WOOD, Wood::SPRUCE, 1)));
			$this->registerRecipe((new ShapedRecipe(
				Item::get(Item::WOODEN_PLANK, Planks::BIRCH, 4),
				"X"
			))->setIngredient("X", Item::get(Item::WOOD, Wood::BIRCH, 1)));
			$this->registerRecipe((new ShapedRecipe(
				Item::get(Item::WOODEN_PLANK, Planks::JUNGLE, 4),
				"X"
			))->setIngredient("X", Item::get(Item::WOOD, Wood::JUNGLE, 1)));
			$this->registerRecipe((new ShapedRecipe(
				Item::get(Item::WOODEN_PLANK, Planks::ACACIA, 4),
				"X"
			))->setIngredient("X", Item::get(Item::WOOD2, Wood2::ACACIA, 1)));
			$this->registerRecipe((new ShapedRecipe(
				Item::get(Item::WOODEN_PLANK, Planks::DARK_OAK, 4),
				"X"
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::INACTIVE_REDSTONE_LAMP, 0, 1),
				" R ",
				"RGR",
				" R "
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::STONE_BRICK, 3, 1),
				"   ",
				"PP "
			))->setIngredient("P", Item::get(Item::SLAB, 5, 2)));

			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::SLAB, 1, 6),
				"PPP",
				"   ",
				"   "
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::RED_SANDSTONE_SLAB, 0, 6),
				"PPP",
				"   ",
				"   "
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::QUARTZ_BLOCK, 0, 1),
				"XX ",
				"XX ",
				"   "
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::COBBLESTONE_WALL, 0, 6),
				"PPP",
				"PPP",
				"   "
			))->setIngredient("P", Item::get(Item::COBBLESTONE, 0, 6)));
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::COBBLESTONE_WALL, 1, 6),
				"PPP",
				"PPP",
				"   "
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::QUARTZ_BLOCK, 2, 2),
				"P  ",
				"P  ",
				"   "
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::RED_SANDSTONE_STAIRS, 0, 4),
				"P  ",
				"PP ",
				"PPP"
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::STONE, Stone::GRANITE, 1),
				"   ",
				" Y ",
				" X "
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::STONE, Stone::DIORITE, 2),
				"YY ",
				"XX ",
				"   "
			...
			$this->registerRecipe((new BigShapedRecipe(
				Item::get(Item::STONE, Stone::ANDESITE, 2),
				"   ",
				" Y ",
				" X "
