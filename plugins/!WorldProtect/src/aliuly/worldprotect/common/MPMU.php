...
abstract class MPMU{
	 ...
	 * @return string|bool
	 */
	public static function apiVersion(string $version = "") {
	 ...
	 * @return bool
	 */
	public static function apiCheck(string $api, string $version): bool {
	 ...
	 * @return string
	 */
	public static function gamemodeStr(int $mode): string {
	 ...
	 * @return bool
	 */
	public static function access(CommandSender $sender, string $permission, bool $msg = true): bool {
	 ...
	 * @return bool
	 */
	public static function inGame(CommandSender $sender, bool $msg = true): bool {
	 ...
	 * @return string
	 */
	public static function iName(Player $player): string {
	 ...
	 * @return string|null
	 */
	public static function getResourceContents(Plugin $plugin, string $filename): string {
	 ...
	 * @return mixed
	 */
	public static function callPlugin(Server $server, array $plug, string $method, array $args, mixed $default = null): mixed {
		$v = null;
		if(is_array($plug)){
			list($plug, $v) = $plug;
		}
	 ...
	 */
	public static function addCommand(Plugin $plugin, CommandExecutor $executor, string $cmd, array $yaml){
	 ...
	 * @deprecated Moved to Cmd class
	 */
	public static function rmCommand(Server $srv, string $cmd): bool {
	 ...
	 * @param string $msg
	 */
	public static function sendPopup(Player $player, string $msg): void {
	 ...
	 * @return string|null
	 */
	public static function startsWith(string $txt, string $tok): string {
		$ln = strlen($tok);
	 ...
	 * @return Player|null
	 */
	public static function getPlayer(CommandSender $c, string $n): Player {
