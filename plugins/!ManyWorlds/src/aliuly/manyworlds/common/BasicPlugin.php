...
abstract class BasicPlugin extends PluginBase{
	 ...
	 */
	public function cfgSave(string $key, mixed $settings) {
	 ...
	 */
	protected function dispatchSCmd(CommandSender $sender, Command $cmd, array $args, $data = null) : bool{
	 ...
	 */
	public function getState(string $label, CommandSender $player, $default) {
	 ...
	 */
	public function setState(string $label, CommandSender $player, $val) {
	 ...
	 */
	public function unsetState(string $label, CommandSender $player){
