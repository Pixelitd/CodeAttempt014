...
class TextFilter extends PluginBase {
    
    /** @var string */
	const PREFIX = "[TextFilter]";
	...
	public function onLoad(){
	    if(!(self::$instance instanceof TextFilter)){
	        self::$instance = $this;
	    }
	}
	...
	public function onEnable(){
		...
		$this->getCommand("textfilter")->setExecutor(new Commands\Commands($this));
	...
	/**
	 * Reload TextFilter configuration
	 */
