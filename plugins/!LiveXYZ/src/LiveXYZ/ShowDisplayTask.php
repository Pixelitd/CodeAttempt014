...
class ShowDisplayTask extends PluginTask{
	...
	public function onRun($currentTick){
		...
		$location = "Location: " . TextFormat::WHITE . "(" . Utils::getFormattedCoords($this->player->getX(), $this->player->getY(), $this->player->getZ()) . ")" . TextFormat::WHITE . "\n";
		$world = "Level: " . TextFormat::WHITE . $this->player->getLevel()->getName() . TextFormat::WHITE . "\n";
		$direction = "Direction: " . TextFormat::WHITE . Utils::getCompassDirection($this->player->getYaw()) . " (" . $this->player->getYaw() . ")" . TextFormat::WHITE ."\n";
